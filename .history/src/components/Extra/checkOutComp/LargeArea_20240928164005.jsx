...
function LargeArea() {
  ...
  const [isFormSubmmited, setIsFormSubmited] = useState(false);
  return (
    <div className="largeArea">
      ...
      {isFormSubmmited && (
        <div>
          <h2>We are Facing Some Technical Issues. Our Customer Support Will Contact You within 5 min. Sorry for any inconvenience.💥 </h2>
        </div>
      )}
    </div>
  );
