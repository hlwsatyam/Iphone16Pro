...
function LargeArea() {
  ...
  const validateForm = () => {
    if (!formData.fullName || !formData.mobileNumber || !formData.city || !formData.state || !formData.address || !formData.pincode) {
    ...
    if (formData.paymentMethod !== "Cash On Delivery" && (!formData.cardNumber || !formData.expiryMonth || !formData.expiryYear || !formData.cvv)) {
